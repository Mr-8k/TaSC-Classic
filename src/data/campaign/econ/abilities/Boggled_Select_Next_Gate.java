...
public class Boggled_Select_Next_Gate extends BaseDurationAbility
{
    public Boggled_Select_Next_Gate() { }
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded)
    {
        ...
        LabelAPI title = tooltip.addTitle("Select Next Gate");
        float pad = 10.0F;
        tooltip.addPara("Switch your destination gate selection to the next gate in the sequence. The name of the selected gate will appear above your fleet.", pad, highlight, new String[]{});
