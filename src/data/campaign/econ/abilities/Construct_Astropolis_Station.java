...
public class Construct_Astropolis_Station extends BaseDurationAbility
{
    ...
    protected void activateImpl()
    {
        ...
        else if(numAstro == 1)
        {
            ...
            MarketAPI market = Global.getFactory().createMarket(targetPlanet.getName() + "astropolisBetaMarket", newAstropolis.getName(), 3);
            market.setSize(3);
        ...
        else if(numAstro == 2)
        {
            ...
            //Create the astropolis market
            MarketAPI market = Global.getFactory().createMarket(targetPlanet.getName() + "astropolisGammaMarket", newAstropolis.getName(), 3);
            market.setSize(3);
