...
import data.campaign.econ.industries.Atmosphere_Processor;

public class BoggledNanoforgeInstallableItemPlugin extends BaseInstallableIndustryItemPlugin
{
    private Atmosphere_Processor industry;

    public BoggledNanoforgeInstallableItemPlugin(Atmosphere_Processor industry) {
        this.industry = industry;
    }

    public static Map<String, BoggledNanoforgeInstallableItemPlugin.NanoforgeEffect> NANOFORGE_EFFECTS = new HashMap<String, BoggledNanoforgeInstallableItemPlugin.NanoforgeEffect>()
    {
        {
            this.put("corrupted_nanoforge", new BoggledNanoforgeInstallableItemPlugin.NanoforgeEffect()
            {
                ...
                public void addItemDescription(TooltipMakerAPI text, SpecialItemData data, InstallableItemDescriptionMode mode)
                {
                    ...
                    text.addPara(pre + "Adds an additional %s terraforming progress points per day.", pad, Misc.getHighlightColor(), new String[]{"3"});
                }
            });
            this.put("pristine_nanoforge", new BoggledNanoforgeInstallableItemPlugin.NanoforgeEffect()
            {
                public void apply(Industry industry) { }
                ...
                public void addItemDescription(TooltipMakerAPI text, SpecialItemData data, InstallableItemDescriptionMode mode)
                {
                    ...
                    text.addPara(pre + "Adds an additional %s terraforming progress points per day.", pad, Misc.getHighlightColor(), new String[]{"6"});
                }
            });
        }
    };
