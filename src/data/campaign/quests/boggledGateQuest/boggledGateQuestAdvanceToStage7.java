...
public class boggledGateQuestAdvanceToStage7 extends BaseCommandPlugin
{
    @Override
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap)
    {
        ...
        Global.getSector().getPlayerFleet().addTag("boggled_gate_quest_stage7");
        ...
        Iterator allEntries = Global.getSector().getEntityById("ancyra").getMarket().getCommDirectory().getEntriesCopy().iterator();
