...
public class progressQuestToIlmEnding extends BaseCommandPlugin
{
    @Override
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap)
    {
        ...
        playerFleet.addTag("boggled_lobster_quest_stage5");

        boggledTools.getPlanetTokenForQuest("Askonia", "cruor").removeTag("boggled_lobster_quest_fireVegaRescue");
        if(Global.getSector().getPlayerFleet().hasTag("boggled_lobster_quest_playerSmashedTheirTriPad"))
        {
            boggledTools.getPlanetTokenForQuest("Zagan", "ilm").addTag("boggled_lobster_quest_fireIlmInteractionNoBattle");
        }
        else
        {
            boggledTools.getPlanetTokenForQuest("Zagan", "ilm").addTag("boggled_lobster_quest_fireIlmInteractionWithBattle");
        }
        ...
        Misc.makeImportant(boggledTools.getPlanetTokenForQuest("Zagan", "ilm"), "boggled_ilm_importance");
