...
public class progressQuestToUmbraMeeting extends BaseCommandPlugin
{
    @Override
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap)
    {
        ...
        playerFleet.addTag("boggled_lobster_quest_stage3");

        boggledTools.getPlanetTokenForQuest("Askonia", "cruor").removeTag("boggled_lobster_quest_fireVegaRescue");
        boggledTools.getPlanetTokenForQuest("Askonia", "umbra").addTag("boggled_lobster_quest_fireSimmonsUmbraInteraction");
        ...
        Misc.makeImportant(boggledTools.getPlanetTokenForQuest("Askonia", "umbra"), "boggled_umbra_importance");
