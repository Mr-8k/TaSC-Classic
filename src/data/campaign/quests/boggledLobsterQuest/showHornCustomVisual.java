...
public class showHornCustomVisual extends BaseCommandPlugin
{
    @Override
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap)
    {
        ...
        PersonAPI boggledLobsterQuestCommandant = fac.createPerson();
        ...
        boggledLobsterQuestCommandant.setFaction(Global.getSector().getEntityById("cruor").getMarket().getFaction().getId());
        ...
        dialog.getVisualPanel().showPersonInfo(boggledLobsterQuestCommandant, true);
